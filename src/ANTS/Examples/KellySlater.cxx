      ...
      while( ttiter < numtimepoints )  // N time integration points
	{
	  ...
	  /*
          typedef itk::DisplacementFieldJacobianDeterminantFilter<
               DeformationFieldType >  jFilterType;
          typename jFilterType::Pointer jfilter = jFilterType::New();
          jfilter->SetInput( invfield );
          jfilter->SetUseImageSpacingOn();
          jfilter->Update();
	  */
...
//speed function here IMPORTANT!!
	      ...
	      RealType jac=1;//jfilter->GetOutput()->GetPixel(speedindex);
	      dd*=(gm->GetPixel(speedindex)*jac);
